...
var utils = {
    ...
    appendSVGMasks : function(wrapperID,desktopVideoID,videoSRC,mobileImgID,mobileImgSrc){
        if(document.documentElement.clientWidth>699){

            if(document.getElementById(desktopVideoID)===null){
                var vid = document.createElement('video');
                
                vid.setAttribute("muted","true");
                vid.setAttribute("autoplay","true");
                vid.setAttribute("loop","true");
                vid.setAttribute("id",desktopVideoID);
                vid.setAttribute("src",videoSRC);

                document.getElementById(wrapperID).appendChild(vid);
            }
        }else{
            if(document.getElementById(mobileImgID)===null){
                var img = document.createElement('img');
                
                img.setAttribute("src",mobileImgSrc);
                img.setAttribute("alt","");
                img.setAttribute("id",mobileImgID);
